				   ...
				   serviceRecordHandle:(BluetoothSDPServiceRecordHandle *)outServiceRecordHandle
{
	...
	// publish the service
	IOReturn status = [IOBluetoothSDPServiceRecord
										publishedServiceRecordWithDictionary:sdpEntries];
...
{
	return [IOBluetoothSDPServiceRecord removeServiceRecord:handle];
}
